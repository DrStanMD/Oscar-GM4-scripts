...
function showAlert4()
{
  ...
  if (params.docType == 'HL7') {
    myDocLink = vPath + 'lab/CA/ALL/labDisplay.jsp?&segmentID=' + params.docId + '&providerNo=1'    //myDocLink =vPath + "lab/CA/ALL/labDisplay.jsp?&amp;segmentID" +params.docId +"&amp;providerNo=1"    
  }
