...
newlist = '<br><a href=' + vPath + 'oscarReport/reportByTemplate/addEditTemplate.jsp style=\'color: #226d55; font-size: 10px;\'>Add Template</a><br>'//newlist=""
for (var i = 0; i < myNewArray.length; i++) {
  //**************************************
  //**************NUMBERED LIST:
  newlist = newlist + '<br>' + (i + 1) + '. ' + myNewArray[i]  //*************WITHOUT NUMBERS
  //newlist = newlist + "<br>"+myNewArray[i]
}//**********REMOVE EXISTING LIST:

$('div.templatelist').html('<a href=' + vPath + 'oscarReport/reportByTemplate/addEditTemplate.jsp style=\'color: #226d55; font-size: 10px;\'>Add Template</a><br>')//**********APPPEND TO BOTTOM:
